...
var changeVariable = document.getElementById("duration-button");
changeVariable.addEventListener("click", changeDuration);

function changeDuration(){
    let durationText =  document.getElementById("duration-text");
    duration = prompt("enter in new duration","insert here");
